...
| reboot_added_host_after_installation | UNDEF | If true reboot host after successful installation. |
| reboot_added_host_after_upgrade | UNDEF | If true reboot host after successful upgrade. |
