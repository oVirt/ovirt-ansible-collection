...
| reboot_added_hosts_after_installation | UNDEF | If true reboot host after successful installation. |
| reboot_added_hosts_after_upgrade | UNDEF | If true reboot hosts after successful upgrade. |
